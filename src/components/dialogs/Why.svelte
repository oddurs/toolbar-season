...
<Dialog {dlg} {close} title="What is this?" icon={I.info} w={440}>
  <div class="why">
    ...
    <p class="muted">Every toolbar here is invented, and this is a parody: not affiliated with Microsoft or anyone else. Sound is on; the switch is bottom left.</p>
  </div>
