...
{#snippet post(who, meta, alt, body)}
  <tr>
...
<div class="forum">
  ...
  <div class="forum-body">
    ...
    <table><tbody>
      ...
      {@render post("sk8rmom72", "Junior Member<br>Posts: 3", false, p1)}
      ...
      {@render post("Mod_Steve", "Moderator<br>Posts: 14,882", true, p2)}
      ...
      {/snippet}
      {@render post("sk8rmom72", "Junior Member<br>Posts: 4", false, p3)}
